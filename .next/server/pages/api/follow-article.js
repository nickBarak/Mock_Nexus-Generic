...
module.exports = __webpack_require__("I2fs");
...
/* harmony default export */ __webpack_exports__["default"] = (async function (req, res) {
  ...
  try {
    ...
    await Object(_db__WEBPACK_IMPORTED_MODULE_1__[/* queryDB */ "c"])(`UPDATE users SET following = array_${!following ? 'append' : 'remove'}(following, $1) WHERE email = $2`, [articleID, email]);
    await Object(_db__WEBPACK_IMPORTED_MODULE_1__[/* queryDB */ "c"])(`UPDATE articles SET followers = array_${!following ? 'append' : 'remove'}(followers, $1) WHERE id = $2`, [email, articleID]);
