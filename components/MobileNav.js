                ...
                [
                    ...
                    <li key={uuid()}>{   
                        category.subcategories
                            ? <>
                        <div>
                            <Link href={isAbout ? '/about' : `/categories/${convertToPath(category.title)}`}>
                                <a style={{ width: '90%' }} onClick={e => {
                                    e.target.parentElement.parentElement.parentElement.style.transform = 'translateX(-100vw)'
                                }}>{category.title}</a>
                            </Link>
                            {category.subcategories && <span style={{ width: '2rem', height: '2rem' }} onClick={e => {
                                e.currentTarget.children[0].style.transform =
                                e.currentTarget.children[0].style.transform === 'rotateX(180deg)' ? 'rotateX(0)' : 'rotateX(180deg)';
