...
function StaffContact() {
    return (
        <Layout>
            <About heading="Mock Nexus Staff">
                ...
                <div className="staff-member">
                    ...
                    <div className="staff-info-container">
                        ...
                        <div className="staff-email">
                            <a href="mailto:eic@mocknexus.com">eic@mocknexus.com</a>
                        </div>
                </div>
                </div>
                ...
                <div className="staff-member">
                    ...
                    <div className="staff-email">
                        <a href="mailto:managing@mocknexus.com">managing@mocknexus.com</a>
                    </div>
                    </div>
                </div>
                ...
                <div className="staff-member">
                    ...
                    <div className="staff-email">
                        <a href="mailto:news@mocknexus.com">news@mocknexus.com</a>
                    </div>
                    </div>
                </div>
                ...
                <div className="staff-member">
                    ...
                    <div className="staff-email">
                        <a href="mailto:data@mocknexus.com">data@mocknexus.com</a>
                    </div>
                    </div>
                </div>
                ...
                <div className="staff-member">
                    ...
                    <div className="staff-email">
                        <a href="mailto:opinion@mocknexus.com">opinion@mocknexus.com</a>
                    </div>
                    </div>
                </div>
                ...
                <div className="staff-member">
                    ...
                    <div className="staff-email">
                        <a href="mailto:sports@mocknexus.com">sports@mocknexus.com</a>
                    </div>
                    </div>
                </div>
                ...
                <div className="staff-member">
                    ...
                    <div className="staff-email">
                        <a href="mailto:artsweek@mocknexus.com">artsweek@mocknexus.com</a>
                    </div>
                    </div>
                </div>
                ...
                <div className="staff-member">
                    ...
                    <div className="staff-email">
                        <a href="mailto:onthemenu@mocknexus.com">onthemenu@mocknexus.com</a>
                    </div>
                    </div>
                </div>
                ...
                <div className="staff-member">
                    ...
                    <div className="staff-email">
                        <a href="mailto:science@mocknexus.com">science@mocknexus.com</a>
                    </div>
                    </div>
                </div>
                ...
                <div className="staff-member">
                    ...
                    <div className="staff-email">
                        <a href="mailto:nexustentialism@mocknexus.com">nexustentialism@mocknexus.com</a>
                    </div>
                    </div>
                </div>
                ...
                <div className="staff-member">
                    ...
                    <div className="staff-email">
                        <a href="mailto:photo@mocknexus.com">photo@mocknexus.com</a>
                    </div>
                    </div>
                </div>
                ...
                <div className="staff-member staff-member-small-picture">
                    ...
                    <div className="staff-email">
                        <a href="mailto:sportsphoto@mocknexus.com">sportsphoto@mocknexus.com</a>
                    </div>
                    </div>
                </div>
                ...
                <div className="staff-member">
                    ...
                    <div className="staff-email">
                        <a href="mailto:video@mocknexus.com">video@mocknexus.com</a>
                    </div>
                    </div>
                </div>
                ...
                <div className="staff-member">
                    ...
                    <div className="staff-email">
                        <a href="mailto:layout@mocknexus.com">layout@mocknexus.com</a>
                    </div>
                    </div>
                </div>
                ...
                <div className="staff-member">
                    ...
                    <div className="staff-email">
                        <a href="mailto:art@mocknexus.com">art@mocknexus.com</a>
                    </div>
                    </div>
                </div>
                ...
                <div className="staff-member staff-member-small-picture">
                    ...
                    <div className="staff-email">
                        <a href="mailto:web@mocknexus.com">web@mocknexus.com</a>
                    </div>
                    </div>
                </div>
                ...
                <div className="staff-member">
                    ...
                    <div className="staff-email">
                        <a href="mailto:socialmedia@mocknexus.com">socialmedia@mocknexus.com</a>
                    </div>
                    </div>
                </div>
                ...
                <div className="staff-member">
                    ...
                    <div className="staff-email">
                        <a href="mailto:copy@mocknexus.com">copy@mocknexus.com</a>
                    </div>
                    </div>
                </div>
