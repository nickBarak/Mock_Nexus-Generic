			...
			<About heading="FAQ">
				<ul>
					<li key="0">
						...
						<div>
							The newspaper prints on Thursday, with online
					...
					<li key="1">
						...
						<div>
							The newspaper holds quarterly training sessions for
					...
					<li key="2">
						...
						<div>
							...
							is an independent student-run publication. The
					...
					<li key="3">
						...
						<div>
							...
							receives about two thirds of its funds from
					...
					<li key="4">
						...
						<div>
							Opinion columns are 600 to 800 words long. The{' '}
							<span style={{ fontStyle: 'italic' }}>
								Daily Nexus
							</span>{' '}
							will not print responses to responses. For example,
							...
							material. Readers should submit their pieces to{' '}
							<span style={{ color: 'var(--link-hover)' }}>
								opinion@dailynexus.com
							</span>
							.
						</div>
					</li>
					<li key="5">
						<div
							...
							What is the editorial policy for the opinion
							section?
						</div>
						<div>
							...
							and cannot be printed in other publications without
							permission. Opinion pieces may be edited for length
							and clarity. This is to allow the maximum amount of
							opinion pieces as possible. Brevity is appreciated.
							<br />
							<br />
							The{' '}
							<span style={{ fontStyle: 'italic' }}>
							...
							will not publish press releases or pieces that
							...
							Isla Vista, Goleta or Santa Barbara.
						</div>
					</li>
					<li key="6">
						<div
						...
						<div>
							We encourage all of our readers to submit comments
							on our website. Comments made on{' '}
							<span style={{ fontStyle: 'italic' }}>
								dailynexus.com
							</span>{' '}
							are not pre-moderated, but can be removed if they
							violate the policy that follows. Any comment may be
							used in the print edition of the Nexus, and we ask
							that you keep your comments brief and on topic.
							<br />
							<br />
							...
							<ul style={{ margin: '1rem 0 1rem 2rem' }}>
								<li
									...
									attacks a named or identified person or
									group unreasonably.
								</li>
								<li
									key="2"
									...
									attacks or demeans one’s race, gender,
								...
								<li
									...
									threatens or encourages violence and/or
									illegal behavior.
								</li>
								<li
									key="4"
									...
									contains racial epithets, sexual
							...
							Comments may be removed or turned off for an article
							if there are concerns regarding an individual’s
							safety. As of May 2020, readers must provide their
							name and email address in order to post a comment.
							<br />
							<br />
							If you believe that your comment was deleted
							inappropriately, please email{' '}
							<span style={{ color: 'var(--link-hover)' }}>
								news@dailynexus.com.
							</span>
						</div>
					...
					<li key="7">
						<div
							...
							How do I submit a complaint, correction or
							retraction request?
						</div>
						<div>
							All requests can be e-mailed to the editor-in-chief
							at{' '}
							<span style={{ color: 'var(--link-hover)' }}>
								eic@dailynexus.com
							</span>{' '}
							or delivered by phone at (805) 893-2691. If you
							believe a factual error was made in a{' '}
							<span style={{ fontStyle: 'italic' }}>
								Daily Nexus
							</span>{' '}
							article, please call our office immediately. If a
							...
							require the reader to provide the burden of proof.
							<br />
							<br />
							With regards to retraction requests, please know
							...
							not acceptable grounds for a retraction.
						</div>
					</li>
					<li key="8">
						<div
						...
						<div>
							Interested parties can contact our advertising
							office by phone at (805) 893-3828 or email{' '}
							<span style={{ color: 'var(--link-hover)' }}>
								production@dailynexus.com.
							</span>
						</div>
					</li>
					<li key="9">
						...
						<div>
							...
							has several desk editors who are assigned to
							...
							<br />
							<br />
							Please call or e-mail your story ideas to these
							...
							staffers. We do not accept freelance work unless it
					...
					<li key="10">
						...
						<div>
							Our newspaper is printed at the Santa Barbara
							News-Press printing facility located in Goleta.
						</div>
					</li>
